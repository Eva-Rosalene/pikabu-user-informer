...
/***/ function(module, exports, __webpack_require__) {
	...
	var _userContainer = __webpack_require__(1);
	
	var _userContainer2 = _interopRequireDefault(_userContainer);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	new _userContainer2.default().actions();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _user3 = __webpack_require__(102);
	...
	var UserContainerView = function () {
	  function UserContainerView() {
	    _classCallCheck(this, UserContainerView);
	
	    this.cache = new _cache2.default();
	    this.userStorage = new _user2.default();
	  }
	
	  _createClass(UserContainerView, [{
	    key: 'actions',
	    value: function actions() {
	      var _this = this;
	
	      $(document).on('mouseover', '.b-comment__user > a:not(.userscript-rendered), a.story__author:not(.userscript-rendered)', function (event) {
	        _this.render(event);
	      });
	
	      $(document).on('mouseout', '.b-comment__user > a:not(.userscript-rendered), a.story__author:not(.userscript-rendered)', function (event) {
	        _this.hide(event);
	      });
	    }
	  }, {
	    ...
	    value: function render(event) {
	      ...
	      var userUrl = event.currentTarget.href;
	      var tooltip = this.resolveContainer(userUrl);
	
	      this.setupOffset(tooltip, event.currentTarget);
	
	      $('body').append(tooltip);
	
	      var userPromise = _this.userStorage.match(userUrl);
	      var userView = new _user4.default(userPromise);
	
	      userView.render().done(function (html) {
	        tooltip.html(html);
	    ...
	    value: function resolveContainer(userUrl) {
	      var tooltip = void 0;
	      ...
	      tooltip.addClass('tooltip-profile').css('position', 'absolute').css('display', 'block').css('z-index', '1000000').css('width', '460px').css('minHeight', '121px').css('background', '#f0f1eb').css('border-radius', '3px').css('border', '1px solid #d0dde5').css('padding', '15px').html('');
	
	      return tooltip;
	    }
	  }, {
	    key: 'setupOffset',
	    value: function setupOffset(tooltip, targetElement) {
	      var offset = $(targetElement).offset();
	
	      tooltip.css('left', offset.left - 2 + 'px').css('top', offset.top + targetElement.offsetHeight + 2 + 'px');
	...
	exports.default = UserContainerView;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [
		...
		__webpack_require__(41) // parent, contents
	], __WEBPACK_AMD_DEFINE_RESULT__ = function( jQuery ) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(24) ], __WEBPACK_AMD_DEFINE_RESULT__ = function() {
		"use strict";
	}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	...
	var UserView = function () {
	  ...
	  _createClass(UserView, [{
	    ...
	    value: function render() {
	      ...
	      return this.userPromise.then(function (userDOM) {
	        var profile = $(userDOM).find('.profile_wrap');
	
	        profile.find('table td').eq(2).remove();
	        profile.find('.b-button').eq(0).remove();
	        profile.find('.user-profile-tools').eq(0).remove();
	
	        profile.css('width', 'inherit').css('maxWidth', '460px').css('padding', '0px').css('margin', '0px');
